...
inline void TransitionImageLayout(VkCommandBuffer CommandBuffer, VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mips, uint32_t count)
{
...
inline void CopyBufferToImage(VkCommandBuffer CommandBuffer, VkBuffer buffer, VkImage image, uint32_t width, uint32_t height, uint32_t mip, uint32_t depth)
{
        ...
        region.imageOffset = { 0, 0, static_cast<int32_t>( depth) };
        region.imageExtent = {
