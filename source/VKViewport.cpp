...
VkRenderPassBeginInfo VKViewport::GetRenderPass()
{
	...
	m_—learValues[0].color.float32[0] = ClearColor.R32F;
	m_—learValues[0].color.float32[1] = ClearColor.G32F;
	m_—learValues[0].color.float32[2] = ClearColor.B32F;
	m_—learValues[0].color.float32[3] = ClearColor.A32F;
