...
VKRenderViewport::VKRenderViewport(void * Handle, bsize Width_, bsize Height_, bool Fullscreen, bool VSync, const BearGraphics::BearRenderViewportDescription&Description_):Width(Width_),Height(Height_), Description(Description_)
{
...
VkPresentModeKHR VKRenderViewport::ChooseSwapPresentMode(const BearVector<VkPresentModeKHR>& availablePresentModes, bool vsync)
{
...
void VKRenderViewport::CreateSwapChain(bsize width, bsize height, bool vsync)
{
...
void VKRenderViewport::CreateImageView()
{
...
void VKRenderViewport::DestroyImageView()
{
...
void VKRenderViewport::DestroySwapChain(VkSwapchainKHR swapChain)
{
...
void VKRenderViewport::CreateFrameBuffers()
{
...
void VKRenderViewport::DestroyFrameBuffers()
{
	for (uint32_t i = 0; i < Framebuffers.size(); i++)
	{
